-- Parent-safe trip progress info for dashboard card
CREATE OR REPLACE FUNCTION "public"."get_parent_next_stop_info"(
  "booking_id_input" "uuid"
) RETURNS TABLE (
  "next_stop_is_parent" boolean,
  "next_stop_label" text,
  "stops_until_parent" integer,
  "eta_minutes" integer
)
LANGUAGE "plpgsql"
SECURITY DEFINER
...
GRANT ALL ON FUNCTION "public"."get_parent_next_stop_info"("uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_parent_next_stop_info"("uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_parent_next_stop_info"("uuid") TO "service_role";
