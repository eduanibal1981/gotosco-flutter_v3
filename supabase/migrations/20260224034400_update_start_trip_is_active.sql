CREATE OR REPLACE FUNCTION public.start_trip(trip_id_input uuid, driver_lat double precision DEFAULT NULL::double precision, driver_lng double precision DEFAULT NULL::double precision)
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
