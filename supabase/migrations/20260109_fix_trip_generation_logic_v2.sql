-- Migration to update trip generation with schedule times and correct booking types
-- Provided by User
-- Fixes ghost trips logic (checking for children first) and adds schedule times.
