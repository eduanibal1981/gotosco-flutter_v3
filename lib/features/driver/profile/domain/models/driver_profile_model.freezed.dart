...
mixin _$DriverProfileModel {
 ...
 String get id;@JsonKey(name: 'user_id') String get userId; String get name;@JsonKey(name: 'photo_url') String? get photoUrl; String? get phone; String? get email;@JsonKey(name: 'experience_years', fromJson: _parseInt) int get experienceYears;@JsonKey(name: 'license_number') String? get licenseNumber;@JsonKey(name: 'license_expiry') DateTime? get licenseExpiry;@JsonKey(name: 'license_image_url') String? get licenseImageUrl;@JsonKey(name: 'vehicle_type') String get vehicleType;@JsonKey(name: 'vehicle_number') String? get vehicleNumber;@JsonKey(name: 'vehicle_capacity', fromJson: _parseInt) int get vehicleCapacity;@JsonKey(name: 'mulkia_image_url') String? get mulkiaImageUrl;@JsonKey(name: 'vehicle_image_urls') List<String> get vehicleImageUrls;@JsonKey(name: 'price_monthly_two_way', fromJson: _parseDouble) double get priceMonthlyTwoWay;@JsonKey(name: 'price_monthly_one_way', fromJson: _parseDouble) double get priceMonthlyOneWay;@JsonKey(name: 'price_daily', fromJson: _parseDouble) double get priceDaily; String get bio;@JsonKey(fromJson: _parseDouble) double get rating;@JsonKey(name: 'total_reviews', fromJson: _parseInt) int get totalReviews;@JsonKey(name: 'is_verified') bool get isVerified;@JsonKey(name: 'license_verified') bool get licenseVerified;@JsonKey(name: 'insurance_verified') bool get insuranceVerified;@JsonKey(name: 'background_check_verified') bool get backgroundCheckVerified;@JsonKey(name: 'service_areas') List<String> get serviceAreas; List<String> get schools;@JsonKey(name: 'location_text') String? get locationText;@JsonKey(name: 'location_lat') double? get locationLat;@JsonKey(name: 'location_lng') double? get locationLng;@JsonKey(name: 'start_location_text') String? get startLocationText;@JsonKey(name: 'start_location_lat') double? get startLocationLat;@JsonKey(name: 'start_location_lng') double? get startLocationLng;
...
@useResult
$Res call({
 String id,@JsonKey(name: 'user_id') String userId, String name,@JsonKey(name: 'photo_url') String? photoUrl, String? phone, String? email,@JsonKey(name: 'experience_years', fromJson: _parseInt) int experienceYears,@JsonKey(name: 'license_number') String? licenseNumber,@JsonKey(name: 'license_expiry') DateTime? licenseExpiry,@JsonKey(name: 'license_image_url') String? licenseImageUrl,@JsonKey(name: 'vehicle_type') String vehicleType,@JsonKey(name: 'vehicle_number') String? vehicleNumber,@JsonKey(name: 'vehicle_capacity', fromJson: _parseInt) int vehicleCapacity,@JsonKey(name: 'mulkia_image_url') String? mulkiaImageUrl,@JsonKey(name: 'vehicle_image_urls') List<String> vehicleImageUrls,@JsonKey(name: 'price_monthly_two_way', fromJson: _parseDouble) double priceMonthlyTwoWay,@JsonKey(name: 'price_monthly_one_way', fromJson: _parseDouble) double priceMonthlyOneWay,@JsonKey(name: 'price_daily', fromJson: _parseDouble) double priceDaily, String bio,@JsonKey(fromJson: _parseDouble) double rating,@JsonKey(name: 'total_reviews', fromJson: _parseInt) int totalReviews,@JsonKey(name: 'is_verified') bool isVerified,@JsonKey(name: 'license_verified') bool licenseVerified,@JsonKey(name: 'insurance_verified') bool insuranceVerified,@JsonKey(name: 'background_check_verified') bool backgroundCheckVerified,@JsonKey(name: 'service_areas') List<String> serviceAreas, List<String> schools,@JsonKey(name: 'location_text') String? locationText,@JsonKey(name: 'location_lat') double? locationLat,@JsonKey(name: 'location_lng') double? locationLng,@JsonKey(name: 'start_location_text') String? startLocationText,@JsonKey(name: 'start_location_lat') double? startLocationLat,@JsonKey(name: 'start_location_lng') double? startLocationLng
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId,  String name, @JsonKey(name: 'photo_url')  String? photoUrl,  String? phone,  String? email, @JsonKey(name: 'experience_years', fromJson: _parseInt)  int experienceYears, @JsonKey(name: 'license_number')  String? licenseNumber, @JsonKey(name: 'license_expiry')  DateTime? licenseExpiry, @JsonKey(name: 'license_image_url')  String? licenseImageUrl, @JsonKey(name: 'vehicle_type')  String vehicleType, @JsonKey(name: 'vehicle_number')  String? vehicleNumber, @JsonKey(name: 'vehicle_capacity', fromJson: _parseInt)  int vehicleCapacity, @JsonKey(name: 'mulkia_image_url')  String? mulkiaImageUrl, @JsonKey(name: 'vehicle_image_urls')  List<String> vehicleImageUrls, @JsonKey(name: 'price_monthly_two_way', fromJson: _parseDouble)  double priceMonthlyTwoWay, @JsonKey(name: 'price_monthly_one_way', fromJson: _parseDouble)  double priceMonthlyOneWay, @JsonKey(name: 'price_daily', fromJson: _parseDouble)  double priceDaily,  String bio, @JsonKey(fromJson: _parseDouble)  double rating, @JsonKey(name: 'total_reviews', fromJson: _parseInt)  int totalReviews, @JsonKey(name: 'is_verified')  bool isVerified, @JsonKey(name: 'license_verified')  bool licenseVerified, @JsonKey(name: 'insurance_verified')  bool insuranceVerified, @JsonKey(name: 'background_check_verified')  bool backgroundCheckVerified, @JsonKey(name: 'service_areas')  List<String> serviceAreas,  List<String> schools, @JsonKey(name: 'location_text')  String? locationText, @JsonKey(name: 'location_lat')  double? locationLat, @JsonKey(name: 'location_lng')  double? locationLng, @JsonKey(name: 'start_location_text')  String? startLocationText, @JsonKey(name: 'start_location_lat')  double? startLocationLat, @JsonKey(name: 'start_location_lng')  double? startLocationLng)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DriverProfileModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId,  String name, @JsonKey(name: 'photo_url')  String? photoUrl,  String? phone,  String? email, @JsonKey(name: 'experience_years', fromJson: _parseInt)  int experienceYears, @JsonKey(name: 'license_number')  String? licenseNumber, @JsonKey(name: 'license_expiry')  DateTime? licenseExpiry, @JsonKey(name: 'license_image_url')  String? licenseImageUrl, @JsonKey(name: 'vehicle_type')  String vehicleType, @JsonKey(name: 'vehicle_number')  String? vehicleNumber, @JsonKey(name: 'vehicle_capacity', fromJson: _parseInt)  int vehicleCapacity, @JsonKey(name: 'mulkia_image_url')  String? mulkiaImageUrl, @JsonKey(name: 'vehicle_image_urls')  List<String> vehicleImageUrls, @JsonKey(name: 'price_monthly_two_way', fromJson: _parseDouble)  double priceMonthlyTwoWay, @JsonKey(name: 'price_monthly_one_way', fromJson: _parseDouble)  double priceMonthlyOneWay, @JsonKey(name: 'price_daily', fromJson: _parseDouble)  double priceDaily,  String bio, @JsonKey(fromJson: _parseDouble)  double rating, @JsonKey(name: 'total_reviews', fromJson: _parseInt)  int totalReviews, @JsonKey(name: 'is_verified')  bool isVerified, @JsonKey(name: 'license_verified')  bool licenseVerified, @JsonKey(name: 'insurance_verified')  bool insuranceVerified, @JsonKey(name: 'background_check_verified')  bool backgroundCheckVerified, @JsonKey(name: 'service_areas')  List<String> serviceAreas,  List<String> schools, @JsonKey(name: 'location_text')  String? locationText, @JsonKey(name: 'location_lat')  double? locationLat, @JsonKey(name: 'location_lng')  double? locationLng, @JsonKey(name: 'start_location_text')  String? startLocationText, @JsonKey(name: 'start_location_lat')  double? startLocationLat, @JsonKey(name: 'start_location_lng')  double? startLocationLng)  $default,) {final _that = this;
switch (_that) {
case _DriverProfileModel():
return $default(_that.id,_that.userId,_that.name,_that.photoUrl,_that.phone,_that.email,_that.experienceYears,_that.licenseNumber,_that.licenseExpiry,_that.licenseImageUrl,_that.vehicleType,_that.vehicleNumber,_that.vehicleCapacity,_that.mulkiaImageUrl,_that.vehicleImageUrls,_that.priceMonthlyTwoWay,_that.priceMonthlyOneWay,_that.priceDaily,_that.bio,_that.rating,_that.totalReviews,_that.isVerified,_that.licenseVerified,_that.insuranceVerified,_that.backgroundCheckVerified,_that.serviceAreas,_that.schools,_that.locationText,_that.locationLat,_that.locationLng,_that.startLocationText,_that.startLocationLat,_that.startLocationLng);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'user_id')  String userId,  String name, @JsonKey(name: 'photo_url')  String? photoUrl,  String? phone,  String? email, @JsonKey(name: 'experience_years', fromJson: _parseInt)  int experienceYears, @JsonKey(name: 'license_number')  String? licenseNumber, @JsonKey(name: 'license_expiry')  DateTime? licenseExpiry, @JsonKey(name: 'license_image_url')  String? licenseImageUrl, @JsonKey(name: 'vehicle_type')  String vehicleType, @JsonKey(name: 'vehicle_number')  String? vehicleNumber, @JsonKey(name: 'vehicle_capacity', fromJson: _parseInt)  int vehicleCapacity, @JsonKey(name: 'mulkia_image_url')  String? mulkiaImageUrl, @JsonKey(name: 'vehicle_image_urls')  List<String> vehicleImageUrls, @JsonKey(name: 'price_monthly_two_way', fromJson: _parseDouble)  double priceMonthlyTwoWay, @JsonKey(name: 'price_monthly_one_way', fromJson: _parseDouble)  double priceMonthlyOneWay, @JsonKey(name: 'price_daily', fromJson: _parseDouble)  double priceDaily,  String bio, @JsonKey(fromJson: _parseDouble)  double rating, @JsonKey(name: 'total_reviews', fromJson: _parseInt)  int totalReviews, @JsonKey(name: 'is_verified')  bool isVerified, @JsonKey(name: 'license_verified')  bool licenseVerified, @JsonKey(name: 'insurance_verified')  bool insuranceVerified, @JsonKey(name: 'background_check_verified')  bool backgroundCheckVerified, @JsonKey(name: 'service_areas')  List<String> serviceAreas,  List<String> schools, @JsonKey(name: 'location_text')  String? locationText, @JsonKey(name: 'location_lat')  double? locationLat, @JsonKey(name: 'location_lng')  double? locationLng, @JsonKey(name: 'start_location_text')  String? startLocationText, @JsonKey(name: 'start_location_lat')  double? startLocationLat, @JsonKey(name: 'start_location_lng')  double? startLocationLng)?  $default,) {final _that = this;
switch (_that) {
case _DriverProfileModel() when $default != null:
return $default(_that.id,_that.userId,_that.name,_that.photoUrl,_that.phone,_that.email,_that.experienceYears,_that.licenseNumber,_that.licenseExpiry,_that.licenseImageUrl,_that.vehicleType,_that.vehicleNumber,_that.vehicleCapacity,_that.mulkiaImageUrl,_that.vehicleImageUrls,_that.priceMonthlyTwoWay,_that.priceMonthlyOneWay,_that.priceDaily,_that.bio,_that.rating,_that.totalReviews,_that.isVerified,_that.licenseVerified,_that.insuranceVerified,_that.backgroundCheckVerified,_that.serviceAreas,_that.schools,_that.locationText,_that.locationLat,_that.locationLng,_that.startLocationText,_that.startLocationLat,_that.startLocationLng);case _:
  return null;
...
class _DriverProfileModel extends DriverProfileModel {
  const _DriverProfileModel({required this.id, @JsonKey(name: 'user_id') required this.userId, required this.name, @JsonKey(name: 'photo_url') this.photoUrl, this.phone, this.email, @JsonKey(name: 'experience_years', fromJson: _parseInt) this.experienceYears = 0, @JsonKey(name: 'license_number') this.licenseNumber, @JsonKey(name: 'license_expiry') this.licenseExpiry, @JsonKey(name: 'license_image_url') this.licenseImageUrl, @JsonKey(name: 'vehicle_type') required this.vehicleType, @JsonKey(name: 'vehicle_number') this.vehicleNumber, @JsonKey(name: 'vehicle_capacity', fromJson: _parseInt) this.vehicleCapacity = 0, @JsonKey(name: 'mulkia_image_url') this.mulkiaImageUrl, @JsonKey(name: 'vehicle_image_urls') final  List<String> vehicleImageUrls = const [], @JsonKey(name: 'price_monthly_two_way', fromJson: _parseDouble) this.priceMonthlyTwoWay = 0, @JsonKey(name: 'price_monthly_one_way', fromJson: _parseDouble) this.priceMonthlyOneWay = 0, @JsonKey(name: 'price_daily', fromJson: _parseDouble) this.priceDaily = 0, this.bio = '', @JsonKey(fromJson: _parseDouble) this.rating = 0, @JsonKey(name: 'total_reviews', fromJson: _parseInt) this.totalReviews = 0, @JsonKey(name: 'is_verified') this.isVerified = false, @JsonKey(name: 'license_verified') this.licenseVerified = false, @JsonKey(name: 'insurance_verified') this.insuranceVerified = false, @JsonKey(name: 'background_check_verified') this.backgroundCheckVerified = false, @JsonKey(name: 'service_areas') final  List<String> serviceAreas = const [], final  List<String> schools = const [], @JsonKey(name: 'location_text') this.locationText, @JsonKey(name: 'location_lat') this.locationLat, @JsonKey(name: 'location_lng') this.locationLng, @JsonKey(name: 'start_location_text') this.startLocationText, @JsonKey(name: 'start_location_lat') this.startLocationLat, @JsonKey(name: 'start_location_lng') this.startLocationLng}): _vehicleImageUrls = vehicleImageUrls,_serviceAreas = serviceAreas,_schools = schools,super._();
...
@override@JsonKey(name: 'experience_years', fromJson: _parseInt) final  int experienceYears;
...
@override@JsonKey(name: 'vehicle_capacity', fromJson: _parseInt) final  int vehicleCapacity;
...
@override@JsonKey(name: 'price_monthly_two_way', fromJson: _parseDouble) final  double priceMonthlyTwoWay;
@override@JsonKey(name: 'price_monthly_one_way', fromJson: _parseDouble) final  double priceMonthlyOneWay;
@override@JsonKey(name: 'price_daily', fromJson: _parseDouble) final  double priceDaily;
@override@JsonKey() final  String bio;
@override@JsonKey(fromJson: _parseDouble) final  double rating;
@override@JsonKey(name: 'total_reviews', fromJson: _parseInt) final  int totalReviews;
...
/// Create a copy of DriverProfileModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? name = null,Object? photoUrl = freezed,Object? phone = freezed,Object? email = freezed,Object? experienceYears = null,Object? licenseNumber = freezed,Object? licenseExpiry = freezed,Object? licenseImageUrl = freezed,Object? vehicleType = null,Object? vehicleNumber = freezed,Object? vehicleCapacity = null,Object? mulkiaImageUrl = freezed,Object? vehicleImageUrls = null,Object? priceMonthlyTwoWay = null,Object? priceMonthlyOneWay = null,Object? priceDaily = null,Object? bio = null,Object? rating = null,Object? totalReviews = null,Object? isVerified = null,Object? licenseVerified = null,Object? insuranceVerified = null,Object? backgroundCheckVerified = null,Object? serviceAreas = null,Object? schools = null,Object? locationText = freezed,Object? locationLat = freezed,Object? locationLng = freezed,Object? startLocationText = freezed,Object? startLocationLat = freezed,Object? startLocationLng = freezed,}) {
