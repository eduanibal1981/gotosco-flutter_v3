...
// Single student (backward compatibility)
 ...
 List<String> get studentIds;// Parent booking for themselves
 bool get isForParent;// Multi-School Support
...
// Step 6: Review / Metadata
 ...
 bool get isPublicRequest; int get currentStep; String get flowStep;
...
/// Create a copy of BookingDraftModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? studentId = freezed,Object? studentIds = null,Object? isForParent = null,Object? isMultiSchool = null,Object? schoolLocations = null,Object? tripCategory = null,Object? bookingType = freezed,Object? pickupLocationText = freezed,Object? pickupLat = freezed,Object? pickupLng = freezed,Object? dropoffLocationText = freezed,Object? dropoffLat = freezed,Object? dropoffLng = freezed,Object? isOneTime = null,Object? isRecurring = null,Object? isMonthlySubscription = null,Object? scheduledPickupDatetime = freezed,Object? scheduledDropoffDatetime = freezed,Object? contractStartDate = freezed,Object? contractEndDate = freezed,Object? recurringDays = freezed,Object? homePickupTime = freezed,Object? schoolPickupTime = freezed,Object? driverId = freezed,Object? estimatedPrice = freezed,Object? totalEstimatedDistanceKm = freezed,Object? totalEstimatedDurationMinutes = freezed,Object? notes = freezed,Object? isPublicRequest = null,Object? currentStep = null,Object? flowStep = null,}) {
...
as List<String>,isForParent: null == isForParent ? _self.isForParent : isForParent // ignore: cast_nullable_to_non_nullable
...
as String?,isPublicRequest: null == isPublicRequest ? _self.isPublicRequest : isPublicRequest // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? studentId,  List<String> studentIds,  bool isForParent,  bool isMultiSchool,  List<SchoolLocationModel> schoolLocations,  String tripCategory,  String? bookingType,  String? pickupLocationText,  double? pickupLat,  double? pickupLng,  String? dropoffLocationText,  double? dropoffLat,  double? dropoffLng,  bool isOneTime,  bool isRecurring,  bool isMonthlySubscription,  DateTime? scheduledPickupDatetime,  DateTime? scheduledDropoffDatetime,  DateTime? contractStartDate,  DateTime? contractEndDate,  List<String>? recurringDays,  String? homePickupTime,  String? schoolPickupTime,  String? driverId,  double? estimatedPrice,  double? totalEstimatedDistanceKm,  int? totalEstimatedDurationMinutes,  String? notes,  bool isPublicRequest,  int currentStep,  String flowStep)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BookingDraftModel() when $default != null:
return $default(_that.studentId,_that.studentIds,_that.isForParent,_that.isMultiSchool,_that.schoolLocations,_that.tripCategory,_that.bookingType,_that.pickupLocationText,_that.pickupLat,_that.pickupLng,_that.dropoffLocationText,_that.dropoffLat,_that.dropoffLng,_that.isOneTime,_that.isRecurring,_that.isMonthlySubscription,_that.scheduledPickupDatetime,_that.scheduledDropoffDatetime,_that.contractStartDate,_that.contractEndDate,_that.recurringDays,_that.homePickupTime,_that.schoolPickupTime,_that.driverId,_that.estimatedPrice,_that.totalEstimatedDistanceKm,_that.totalEstimatedDurationMinutes,_that.notes,_that.isPublicRequest,_that.currentStep,_that.flowStep);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? studentId,  List<String> studentIds,  bool isForParent,  bool isMultiSchool,  List<SchoolLocationModel> schoolLocations,  String tripCategory,  String? bookingType,  String? pickupLocationText,  double? pickupLat,  double? pickupLng,  String? dropoffLocationText,  double? dropoffLat,  double? dropoffLng,  bool isOneTime,  bool isRecurring,  bool isMonthlySubscription,  DateTime? scheduledPickupDatetime,  DateTime? scheduledDropoffDatetime,  DateTime? contractStartDate,  DateTime? contractEndDate,  List<String>? recurringDays,  String? homePickupTime,  String? schoolPickupTime,  String? driverId,  double? estimatedPrice,  double? totalEstimatedDistanceKm,  int? totalEstimatedDurationMinutes,  String? notes,  bool isPublicRequest,  int currentStep,  String flowStep)  $default,) {final _that = this;
switch (_that) {
case _BookingDraftModel():
return $default(_that.studentId,_that.studentIds,_that.isForParent,_that.isMultiSchool,_that.schoolLocations,_that.tripCategory,_that.bookingType,_that.pickupLocationText,_that.pickupLat,_that.pickupLng,_that.dropoffLocationText,_that.dropoffLat,_that.dropoffLng,_that.isOneTime,_that.isRecurring,_that.isMonthlySubscription,_that.scheduledPickupDatetime,_that.scheduledDropoffDatetime,_that.contractStartDate,_that.contractEndDate,_that.recurringDays,_that.homePickupTime,_that.schoolPickupTime,_that.driverId,_that.estimatedPrice,_that.totalEstimatedDistanceKm,_that.totalEstimatedDurationMinutes,_that.notes,_that.isPublicRequest,_that.currentStep,_that.flowStep);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? studentId,  List<String> studentIds,  bool isForParent,  bool isMultiSchool,  List<SchoolLocationModel> schoolLocations,  String tripCategory,  String? bookingType,  String? pickupLocationText,  double? pickupLat,  double? pickupLng,  String? dropoffLocationText,  double? dropoffLat,  double? dropoffLng,  bool isOneTime,  bool isRecurring,  bool isMonthlySubscription,  DateTime? scheduledPickupDatetime,  DateTime? scheduledDropoffDatetime,  DateTime? contractStartDate,  DateTime? contractEndDate,  List<String>? recurringDays,  String? homePickupTime,  String? schoolPickupTime,  String? driverId,  double? estimatedPrice,  double? totalEstimatedDistanceKm,  int? totalEstimatedDurationMinutes,  String? notes,  bool isPublicRequest,  int currentStep,  String flowStep)?  $default,) {final _that = this;
switch (_that) {
case _BookingDraftModel() when $default != null:
return $default(_that.studentId,_that.studentIds,_that.isForParent,_that.isMultiSchool,_that.schoolLocations,_that.tripCategory,_that.bookingType,_that.pickupLocationText,_that.pickupLat,_that.pickupLng,_that.dropoffLocationText,_that.dropoffLat,_that.dropoffLng,_that.isOneTime,_that.isRecurring,_that.isMonthlySubscription,_that.scheduledPickupDatetime,_that.scheduledDropoffDatetime,_that.contractStartDate,_that.contractEndDate,_that.recurringDays,_that.homePickupTime,_that.schoolPickupTime,_that.driverId,_that.estimatedPrice,_that.totalEstimatedDistanceKm,_that.totalEstimatedDurationMinutes,_that.notes,_that.isPublicRequest,_that.currentStep,_that.flowStep);case _:
  return null;
...
// Current flow state
@override@JsonKey() final  bool isPublicRequest;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,studentId,const DeepCollectionEquality().hash(_studentIds),isForParent,isMultiSchool,const DeepCollectionEquality().hash(_schoolLocations),tripCategory,bookingType,pickupLocationText,pickupLat,pickupLng,dropoffLocationText,dropoffLat,dropoffLng,isOneTime,isRecurring,isMonthlySubscription,scheduledPickupDatetime,scheduledDropoffDatetime,contractStartDate,contractEndDate,const DeepCollectionEquality().hash(_recurringDays),homePickupTime,schoolPickupTime,driverId,estimatedPrice,totalEstimatedDistanceKm,totalEstimatedDurationMinutes,notes,isPublicRequest,currentStep,flowStep]);
